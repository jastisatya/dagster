...
def helm_chart(
    ...
    try:
        ...
        try:
            ...
            --set dagit.env_from_config_maps={{test-env-configmap}} \\
            --set dagit.env_from_secrets={{test-env-secret}} \\
            ...
            --set job_runner.env_from_config_maps={{test-env-configmap}} \\
            --set job_runner.env_from_secrets={{test-env-secret}} \\
...
def run_launcher(
    ...
    return K8sRunLauncher(
        ...
        env_from_config_maps=['test-env-configmap'],
        env_from_secrets=['test-env-secret'],
    )
